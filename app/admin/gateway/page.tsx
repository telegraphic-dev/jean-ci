...
export default function GatewayPlaygroundPage() {
  ...
  async function sendChatMessage() {
    ...
    try {
      ...
      const assistantText = payload.ok ? extractAssistantText(payload.result) || 'Message sent, but no assistant text found in history yet.' : payload.error || 'No response returned.';
